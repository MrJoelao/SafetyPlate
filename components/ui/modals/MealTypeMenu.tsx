...
export const MealTypeMenu: React.FC<MealTypeMenuProps> = ({ visible, onSelect, onClose }) => {
  ...
  return (
    ...
    >
      {MEAL_TYPES.map((meal) => (
        ...
        >
          <View style={[styles.iconContainer, { backgroundColor: getMealTypeColor(meal.id) }]}>
            <MaterialIcons name={meal.icon as any} size={18} color="#fff" />
          </View>
